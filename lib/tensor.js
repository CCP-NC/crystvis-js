...
import { floatEqual, arraysAlmostEqual } from './utils.js';
    ...
    eulerTo(otherTensor, convention = 'zyz', active = true, eps = 1e-6) {
        ...
        if (this.symmetry == 1 || otherTensor.symmetry == 1) {
            ...
            if (this.symmetry == 1 && otherTensor.symmetry == 1) {
                ...
                let eulerAngles = eulerFromU(Rrel1, convention);
                ...
                // just get the angles from Rel2
                //TODO add tryallangles function and use here!
                let eulerAngles = eulerFromU(Rrel2, convention);
                eulerAngles = normaliseEulerAngles(eulerAngles, active, eps);
                return eulerAngles;
            }
        }
