...
class AtomImage {
     ...
     * 
    * @param {RelativeTensorOrientation}       data   Relative tensor orientation to render.
    ...
    addEulerDisks(data, name, parameters = {}) {
        ...
        if (r) {
            ...
            disks.setOrientation(data, parameters.configurationId)
    ...
    /**
     * Retrieve the EulerDisks primitive instance for a given name, or null.
     * Exposed so callers can drive setConfiguration/animateToConfiguration.
     *
     * @param {String}  name   Name of the Euler disk
     * @return {?EulerDisks}
     */
    getEulerDisks(name) {
        return this._euler_disks[name] ?? null;
    }
