...
class Model {
    ...
    constructor(atoms, parameters = {}) {
        ...
        const initMolecules = ((atoms, supercell) => {
            ...
            */
            ...
            this._isotopes = this._elems.map((el) => data.getIsotopeData(el));
    ...
    /**
     * Add link drawn on model between two atoms
     * 
     * @param {Atom or Array} from      Starting point
     * @param {Atom or Array} to        End point
     ...
     * 
     * @param {String}  name     Name of the graphical object
     */
    removeGraphics(name) {
