...
class AtomMesh extends THREE.Mesh {
    ...
    set atom_opacity(o) {
        ...
        // material.needsUpdate is required when transparent flag changes so
        // Three.js recompiles the shader program for the new blend mode.
        if (this.material.transparent !== wasTransparent) {
