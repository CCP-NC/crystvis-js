...
const LABEL_HEIGHT  = 0.025; // Height of the label
...
class AxesMesh extends THREE.Group {
    ...
    constructor(lattice, parameters = {}) {
        ...
        var defaults = {
            ...
            zColor: 0x0000ff,
            labels: null,
            bothWays: false, // extend the line into the negative direction also?
        };
        ...
        for (var i = 0; i < 3; ++i) {
            ...
            // copy for the labels
            var labelLength = l;
            if (parameters.bothWays) {
                // set the origin to the negative direction
                origin = dir.clone().multiplyScalar(-1.0 / 3.0);
                l *= 2;
            }
            ...
            if (parameters.labels) {
                ...
                var labelPos = dir.clone().multiplyScalar(labelLength * 1.1);
